...
export default function HookeLaw({
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-4">
      <header className="flex items-center justify-between"><h2 className="text-2xl font-semibold">Hooke's Law — Virtual Lab</h2><div className="text-sm text-muted-foreground">Mass–spring experiment</div></header>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="md:col-span-1 bg-card p-4 rounded shadow space-y-3">
          ...
          <div className="flex gap-2 mt-2">
            ...
            <button onClick={()=>{ xRef.current = x0; vRef.current = 0; dataRef.current = []; crossingsRef.current = []; setMeasuredT(null); setSimTime(0); }} className="flex-1 py-2 rounded bg-muted">Reset</button>
          </div>
          ...
          <div className="mt-2 text-sm">
            ...
            <div className="text-xs text-muted-foreground">Uncertainty ±{_uncertainty}s</div>
          </div>
        </div>

        <div className="md:col-span-2 bg-card p-3 rounded shadow">
          <div className="flex items-center justify-between mb-2">
            <div><strong>Mass-Spring Canvas</strong><div className="text-xs text-muted-foreground">Visualize motion and record data</div></div>
      ...
      <div className="bg-card p-4 rounded shadow">
        ...
        <div className="mt-3 grid md:grid-cols-2 gap-4">
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr>
                      ...
                      <th className="border-b border-border p-2">T (s)</th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div><div className="text-sm">Fit (T vs sqrt(m/k) or variant)</div><div className="mt-2 text-xs text-muted-foreground">Use results to estimate relation</div></div>
        </div>
      </div>
