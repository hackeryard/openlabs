    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white p-4 flex flex-col items-center">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex flex-col gap-8 items-center">
          <div className="text-center flex flex-row items-center">
            <p className="mr-2 font-semibold">Input A</p>
            <button
              onClick={() => setA(a ? 0 : 1)}
        ...
        <div className="flex items-center gap-6">
          {/* Input Wire */}
          <div
            className={`w-20 h-2 ${a ? "bg-green-400" : "bg-gray-600"}`}
          ></div>
          ...
          <div className="flex flex-row items-center">
            <p className="mr-4 font-semibold">Output</p>
            <motion.div
      ...
      <div className="mt-8">
        <table className="border border-gray-600 text-center">
          ...
          <tbody>
            {[0, 1].map((x, i) => (
              <tr key={i} className={a === x ? "bg-yellow-500 text-black" : ""}>
                <td className="border px-6 py-2">{x}</td>
                <td className="border px-6 py-2">{x ? 0 : 1}</td>
              </tr>
            ))}
          </tbody>
        </table>
