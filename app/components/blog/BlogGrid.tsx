      ...
      {posts.map((post) => {
        ...
        return (
          ...
          >
            ...
            <motion.article
              variants={item}
              className="relative flex flex-col h-full bg-white/80 backdrop-blur-xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] rounded-[2rem] p-3 transition-all duration-500 hover:-translate-y-2 overflow-hidden"
            >
              ...
              <div className="relative w-full aspect-[4/3] rounded-[1.5rem] overflow-hidden mb-6 z-10 shadow-inner bg-slate-100">
                {post.coverImage ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
                    <IconComponent className="w-16 h-16 text-slate-200" />
                  </div>
                )}
