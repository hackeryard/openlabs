    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-800 pb-20 pt-8 font-sans relative overflow-hidden bg-[radial-gradient(#e2e8f0_1.5px,transparent_1.5px)] bg-[size:24px_24px]">
      ...
      >
        ...
        <div className="space-y-4 mb-12 text-left">
          <motion.div
            variants={item}
            className="inline-flex items-center gap-2 py-1.5 px-3 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-700 text-[10px] font-black uppercase tracking-wider shadow-sm"
          >
        ...
        >
          {cards.map((card) => {
            ...
            const colorClasses =
              card.color === "rose" ? "bg-rose-50 text-rose-600 border-rose-100 group-hover:border-rose-400 group-hover:shadow-rose-100/50" :
            ...
            return (
              ...
              >
                ...
                >
                  <div className="absolute top-0 left-0 right-0 h-1 bg-slate-100 group-hover:bg-emerald-500/20 transition-all" />
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-extrabold text-slate-900 group-hover:text-emerald-600 transition-colors mb-2.5 tracking-tight leading-snug">
                      {card.title}
                    </h3>
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-50 text-[10px] font-extrabold text-emerald-600 flex items-center gap-1 group-hover:translate-x-1 transition-transform">
        ...
        >
          <div className="absolute top-0 right-0 h-32 w-32 bg-emerald-50 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 bg-slate-50 border border-slate-200 p-6 rounded-2xl flex flex-col justify-center text-center shadow-inner">
              ...
              <h4 className="font-extrabold text-slate-900 text-sm mb-1">Living Systems Map</h4>
