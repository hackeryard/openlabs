...
export default function Page() {
  ...
  // Curated, premium HSL pastel cells for the abstract teaser graphic representing the element blocks
  const miniGrid = [
    ...
    { s: "Al", c: "bg-slate-50 border-slate-250 text-slate-600" },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-800 pb-24 pt-8 font-sans relative overflow-hidden bg-[radial-gradient(#e2e8f0_1.5px,transparent_1.5px)] bg-[size:24px_24px]">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-12 pt-4">
          ...
          <div className="lg:col-span-6 text-left space-y-6">
            ...
            <p className="text-slate-655 text-lg leading-relaxed font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <a
                href="#trends"
                className="text-center bg-white hover:bg-slate-50 hover:border-slate-350 text-slate-700 font-bold py-4 px-8 rounded-2xl transition border border-slate-250 active:scale-[0.98] text-base shadow-sm"
              >
                Explore Trends
              </a>
            </div>
        ...
        <section className="space-y-16 border-t border-slate-200 pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              <div className="flex items-center gap-2 text-indigo-600 font-bold uppercase tracking-wider text-xs">
                <Milestone className="h-4 w-4" /> Chemistry Foundations
              </div>
          ...
          <div>
            <div className="text-center mb-12">
              <span className="inline-flex items-center gap-1 bg-indigo-50 text-indigo-755 text-xs font-extrabold uppercase px-2.5 py-1 rounded-md mb-2 animate-pulse">
                Quantum Chemistry
              </span>
          ...
          <div id="trends">
            <div className="text-center mb-12">
              <span className="inline-flex items-center gap-1 bg-indigo-50 text-indigo-755 text-xs font-extrabold uppercase px-2.5 py-1 rounded-md mb-2">
                Atomic Dynamics
              </span>
              <h2 className="text-3xl font-black text-slate-950 tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-lg hover:border-indigo-300 transition duration-300 relative group overflow-hidden">
                ...
                <div className="text-[10px] font-mono font-bold bg-indigo-50 text-indigo-755 border border-indigo-100 px-3 py-1 rounded inline-block">
                  Increases → & Up ↑
                </div>
              </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-3xl p-8 lg:p-12 shadow-md relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                <div className="flex items-center gap-2 text-indigo-600 font-bold uppercase tracking-wider text-xs">
                  <Award className="h-4 w-4" /> Academic & Laboratory Alignment
                </div>
              ...
              <div className="lg:col-span-4 bg-slate-50 border border-slate-200 p-6 rounded-2xl flex flex-col justify-center text-center shadow-inner">
                <Globe className="h-10 w-10 text-indigo-600 mx-auto mb-3 animate-spin [animation-duration:12s]" />
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                <div className="mt-4 text-slate-600 text-sm md:text-base leading-relaxed pl-1 border-t border-slate-55 pt-4">
                  {faq.answer}
                </div>
              </details>
            ))}
