...
const experiments: ChemistryExperiment[] = [
  ...
  },
  {
    ...
    desc: "Perform Bunsen burner flame excitations, observe metal cation colors, and analyze discrete emission spectral lines.",
    formula: "E = hc/λ, ΔE = E₂ - E₁",
    category: "Atomic Structure",
    difficulty: "Beginner",
    duration: "10 min",
  },
  ...
  },
  {
    ...
    desc: "Construct and rotate 3D molecules, calculate steric numbers, lone pair repulsions, and net dipole vectors.",
    formula: "AXnEm Notation, Hybridization",
    category: "Molecular",
    difficulty: "Intermediate",
    duration: "15 min",
  },
