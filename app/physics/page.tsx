...
const experiments: PhysicsExperiment[] = [
  {
    ...
    desc: "Non-linear RK4 oscillations, small vs large angle periods, phase-space trajectories, and energy conservation.",
    formula: "T = 2π√(L/g) [1 + ¼sin²(θ₀/2)]",
    category: "Mechanics",
    difficulty: "Beginner",
    duration: "12 min",
  },
  {
    ...
    desc: "2D trajectory ballistics, rotary cannon aiming, elevation platforms, wind drag, and target challenge mode.",
  ...
  },
  {
    ...
    desc: "Galilean vacuum drops, quadratic aerodynamic drag, terminal velocity, and planetary gravitation across 5 worlds.",
  ...
  },
  {
    ...
    title: "Hooke's Law & Multi-Springs",
    desc: "Single, series, and parallel spring combinations, restoring forces, elastic energy, and mystery mass weighing.",
    formula: "F_s = -k_{\\text{eff}} \\Delta x",
    category: "Mechanics",
    difficulty: "Beginner",
    duration: "12 min",
  },
  {
    ...
    title: "Conservation of Energy & Coasters",
    desc: "Roller coaster track splines, loop-the-loop critical apex velocity, kinetic/potential interchange, and G-forces.",
    formula: "E = mgy + \\frac{1}{2}mv^2 \\quad h_{\\text{min}} = 2.5R",
    category: "Mechanics",
  ...
  },
  {
    ...
    desc: "Linear kinematics, vector overlay dynamics, two-body pursuit race, and synchronized x-t, v-t, a-t graphs.",
    formula: "x(t) = x_0 + v_0 t + \\frac{1}{2}at^2 \\quad v(t) = v_0 + at",
    category: "Mechanics",
    difficulty: "Beginner",
    duration: "15 min",
  },
  ...
  },
  {
    ...
    desc: "Capacitor charging and discharging transients, RC time constants, electron drift, and dual-channel oscilloscope.",
    formula: "\\tau = RC \\quad V_c(t) = V_s(1 - e^{-t/RC})",
    category: "Electricity",
    difficulty: "Intermediate",
    duration: "15 min",
  },
  ...
  },
  {
    ...
    desc: "Convex and concave thin lenses, 3 principal ray paths (P-Ray, F-Ray, Chief Ray), Lensmaker's equation, and real vs virtual images.",
  ...
  },
  {
    ...
    desc: "Young's double slit interference, single-slit Fraunhofer diffraction, 2D Huygens wavelets, and live spectral intensity envelopes.",
    formula: "I(θ) = I₀ cos²(α) sinc²(β)",
    category: "Optics",
    difficulty: "Intermediate",
    duration: "18 min",
  },
  {
    ...
    desc: "Fizeau toothed wheel apparatus, Foucault rotating mirrors, multi-media refractive speeds, and picosecond time-of-flight telemetry.",
    formula: "c = 4ND\\omega \\quad \\text{and} \\quad v = c / n",
    category: "Optics",
    difficulty: "Advanced",
    duration: "20 min",
  },
