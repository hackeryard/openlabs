...
export const LABS: Lab[] = [
  ...
  // ─── PHYSICS ───────────────────────────────────────────
  {
    ...
    description: "Galilean vacuum free fall, aerodynamic drag, and terminal velocity",
  },
  {
    id: "physics/projectilemotion",
    name: "Projectile Motion & Ballistics",
    subject: "physics",
    type: "simulation",
    challengeParams: ["range", "maxHeight", "time"],
    challengeEnabled: true,
    description: "2D trajectory ballistics, launch angles, elevation cliffs, and air drag",
  },
  {
    id: "physics/simplependulum",
    name: "Simple Pendulum & Harmonic Motion",
    subject: "physics",
    type: "simulation",
    challengeParams: ["period", "frequency"],
    challengeEnabled: true,
    description: "Non-linear large-angle oscillations, phase portraits, and energy conservation",
  },
  {
    id: "physics/hookelaw",
    ...
    subject: "physics",
    type: "simulation",
    challengeParams: ["springConstant", "displacement", "force"],
    challengeEnabled: true,
    description: "Series/parallel multi-spring systems, elastic restoring forces, and harmonic oscillations",
  },
  {
    id: "physics/ohmslaw",
    name: "Ohm's Law",
  ...
  },
  {
    ...
    name: "Energy Conservation & Coasters",
    subject: "physics",
    type: "simulation",
    challengeParams: ["speed", "potentialEnergy", "kineticEnergy"],
    challengeEnabled: true,
    description: "Conservation of mechanical energy, roller coaster dynamics, and loop-the-loop physics",
  },
  {
    id: "physics/rclab",
    name: "RC Circuits & Transients",
    subject: "physics",
    type: "simulation",
    challengeParams: ["tau", "vc", "current"],
    challengeEnabled: true,
    description: "Capacitor charging/discharging dynamics, RC time constants, and oscilloscope wave analysis",
  },
  {
    id: "physics/speedoflight",
    name: "Speed of Light & Time-of-Flight",
    subject: "physics",
    type: "simulation",
    challengeParams: ["distanceKm", "timeOfFlightUs", "mediumSpeed"],
    challengeEnabled: true,
    description: "Fizeau toothed wheel apparatus, Foucault rotating mirror, multi-media refractive speeds, and picosecond time-of-flight telemetry",
  },
  {
    id: "physics/uniformmotionlab",
    name: "Uniform Motion & Kinematics",
    subject: "physics",
    type: "simulation",
    challengeParams: ["position", "time", "speed"],
    challengeEnabled: true,
    description: "Linear kinematics, vector overlay dynamics, two-body pursuit race, and synchronized x-t, v-t, a-t graphs",
  },
  {
    id: "physics/waveoptics",
    name: "Wave Optics & Double-Slit Diffraction",
    subject: "physics",
    type: "simulation",
    challengeParams: ["fringeWidth", "wavelength"],
    challengeEnabled: true,
    description: "Young's double-slit interference, single-slit Fraunhofer diffraction, Huygens wavelets, and live spectral intensity envelopes",
  },
  {
    id: "physics/opticslens",
    name: "Geometric Optics & Lens Ray Tracing",
    subject: "physics",
    type: "simulation",
    challengeParams: ["focalLength", "objectDistance", "imageDistance", "magnification"],
    challengeEnabled: true,
    description: "Convex & concave thin lenses, 3 principal ray paths (P-Ray, F-Ray, Chief Ray), Lensmaker's equation, and real/virtual image formations",
  },
  {
