  ...
  // ─── PHYSICS TRACKS ─────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Gravitational acceleration (g = 9.8 m/s²), time-of-flight, and vacuum independence.",
        estimatedMinutes: 15,
      ...
      },
      {
        ...
        description: "2D parabolic flight trajectories, complementary launch angles, and maximum range.",
        estimatedMinutes: 18,
      ...
      },
      {
        ...
        description: "Kinetic and gravitational potential energy exchange on roller coaster tracks.",
        estimatedMinutes: 15,
      ...
      },
      {
        ...
        description: "Small-angle harmonic oscillation, phase-space plots, and period T = 2π√(L/g).",
        estimatedMinutes: 15,
