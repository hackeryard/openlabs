...
export const CURRICULUM_TRACKS: CurriculumTrack[] = [
  ...
  // ─── BIOLOGY TRACKS ─────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      {
        labId: "biology/mitosis-meiosis",
        title: "Mitosis, Meiosis & Cell Division Studio",
        description: "Somatic mitosis, gametic meiosis, chiasmata crossing-over recombination, and nondisjunction aneuploidies.",
        estimatedMinutes: 20,
        simRoute: "/labs/biology/mitosis-meiosis",
        landingRoute: "/biology/mitosis-meiosis",
      },
      {
  ...
  // ─── COMPUTER SCIENCE TRACKS ───────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      {
        labId: "computer-science/dsa/pathfinding-astar",
        title: "A* Pathfinding & Heuristic Search",
        description: "Informed heuristic search f(n) = g(n) + h(n), weighted terrain, and procedural mazes.",
        estimatedMinutes: 20,
        simRoute: "/labs/computer-science/dsa/pathfinding-astar",
        landingRoute: "/computer-science/dsa/pathfinding-astar",
      },
    ],
  },
  {
