...
console.log('End');`,
  ...
  instructions: [
    ...
    { type: 'POP_STACK', codeLine: 4, description: 'console.log returns.' },
    { type: 'POP_STACK', codeLine: 3, description: 'fetchData completes.' },
...
console.log('F');`,
  ...
  instructions: [
    ...
    { type: 'PUSH_STACK', name: 'setTimeout(timer2, 0)', frameType: 'function', codeLine: 13, description: 'setTimeout(timer2, 0) called.' },
    { type: 'ADD_WEB_API', label: 'setTimeout(timer2, 0)', apiType: 'timer', delay: 0, codeLine: 13, description: 'Timer2 registered in Web APIs.' },
    { type: 'POP_STACK', codeLine: 13, description: 'setTimeout returns.' },
    { type: 'REMOVE_WEB_API', label: 'setTimeout(timer2, 0)', codeLine: 13, description: 'Timer2 completes (0ms).' },
    { type: 'ADD_MACROTASK', label: 'timer2', codeLine: 13, description: "'timer2' added to Macrotask Queue (after timer1)." },
    { type: 'PUSH_STACK', name: "console.log('F')", frameType: 'function', codeLine: 17, description: "console.log('F') is called." },
    { type: 'LOG', message: 'F', source: 'sync', codeLine: 17, description: "Outputs 'F'." },
    { type: 'POP_STACK', codeLine: 17, description: 'console.log returns.' },
    { type: 'POP_STACK', codeLine: 17, description: 'Global script finished.' },
    { type: 'SET_PHASE', phase: 'checking-stack', codeLine: 17, description: '🔄 Event Loop: Call Stack empty. Queues: 1 microtask, 2 macrotasks.' },
    { type: 'SET_PHASE', phase: 'draining-microtasks', codeLine: 17, description: '⚡ Microtasks first! Draining micro1.' },
    ...
    { type: 'SET_PHASE', phase: 'draining-microtasks', codeLine: 17, description: '⚡ More microtasks! Draining micro2 before touching macrotasks.' },
    ...
    { type: 'SET_PHASE', phase: 'checking-stack', codeLine: 17, description: '🔄 All microtasks drained. Now checking macrotask queue...' },
    { type: 'SET_PHASE', phase: 'picking-macrotask', codeLine: 17, description: '📋 Taking timer1 from macrotask queue.' },
    ...
    { type: 'SET_PHASE', phase: 'checking-stack', codeLine: 17, description: '🔄 One macrotask done. Check for microtasks (none), then next macrotask.' },
    { type: 'SET_PHASE', phase: 'picking-macrotask', codeLine: 17, description: '📋 Taking timer2 from macrotask queue.' },
    { type: 'REMOVE_MACROTASK', label: 'timer2', codeLine: 13, description: "'timer2' removed from Macrotask Queue." },
    { type: 'PUSH_STACK', name: 'timer2()', frameType: 'callback', codeLine: 13, description: "'timer2' callback executing." },
    { type: 'PUSH_STACK', name: "console.log('E')", frameType: 'function', codeLine: 14, description: "console.log('E') is called." },
    { type: 'LOG', message: 'E', source: 'macrotask', codeLine: 14, description: "Outputs 'E'." },
    { type: 'POP_STACK', codeLine: 14, description: 'console.log returns.' },
    { type: 'POP_STACK', codeLine: 13, description: 'timer2 finished.' },
    { type: 'SET_PHASE', phase: 'idle', codeLine: 17, description: '✅ Final order: A → F → C → D → B → E. Sync first, then all microtasks (including chained ones), then macrotasks one by one.' },
  ],
};
