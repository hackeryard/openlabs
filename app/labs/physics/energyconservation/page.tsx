...
const EnergyConservation = dynamic(() => import('@/app/components/physics/EnergyConservationLab'), {ssr:false, loading:()=> <p className='p-6'>Loading Energy Conservation Lab…</p>})
