      ...
      <div className="max-w-[1360px] mx-auto space-y-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col space-y-6">
            ...
            <div className="bg-card border border-border rounded-3xl p-6 shadow-md space-y-5 text-left">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted border border-border p-4 rounded-2xl flex items-center justify-between shadow-inner">
                  <div>
                  ...
                  <div className="px-4 py-1.5 rounded-full bg-card border border-border text-[10px] font-bold font-mono text-muted-foreground shadow-sm">
            ...
            <div className="bg-card border border-border rounded-3xl p-6 shadow-xl space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* 1. IONIC VIEWPORT */}
                <div className={`rounded-2xl border bg-card shadow-md transition duration-300 flex flex-col justify-between overflow-hidden relative ${predictedBond === "Ionic Bond" ? "ring-2 ring-indigo-500/80 shadow-lg scale-[1.01]" : "opacity-80"}`}>
                  ...
                  <div className="p-4 text-center border-t border-slate-50">
                    <p className="text-[11px] font-semibold text-muted-foreground">Electron Transfer</p>
                    <p className="text-[9px] text-slate-400 font-medium mt-0.5">Electrostatic ion attraction (ΔEN &ge; 1.7)</p>
                  </div>
                </div>

                {/* 2. COVALENT VIEWPORT */}
                <div className={`rounded-2xl border bg-card shadow-md transition duration-300 flex flex-col justify-between overflow-hidden relative ${predictedBond.includes("Covalent") ? "ring-2 ring-indigo-500/80 shadow-lg scale-[1.01]" : "opacity-80"}`}>
                  ...
                  <div className="p-4 text-center border-t border-slate-50">
                    <p className="text-[11px] font-semibold text-muted-foreground">Electron Sharing</p>
                    <p className="text-[9px] text-slate-400 font-medium mt-0.5">Overlapping valence orbits (ΔEN &lt; 1.7)</p>
                  </div>
                </div>

                {/* 3. METALLIC VIEWPORT */}
                <div className="rounded-2xl border bg-card shadow-md hover:shadow-lg transition duration-300 flex flex-col justify-between overflow-hidden relative opacity-85">
                  ...
                  <div className="p-4 text-center border-t border-slate-50">
                    <p className="text-[11px] font-semibold text-muted-foreground">Electron Sea Model</p>
          ...
          <div className="lg:col-span-4 flex flex-col space-y-6 w-full">
            ...
            <div className="bg-card border border-border rounded-3xl p-6 shadow-md space-y-4 text-left">
              <div className="flex items-center gap-2 text-indigo-600 font-bold uppercase tracking-wider text-xs">
              ...
              <div className="space-y-3.5 text-xs font-semibold">
                <div className="flex justify-between items-center bg-muted border border-border p-3 rounded-xl">
                  <span className="text-slate-400 uppercase text-[9px] tracking-wider font-extrabold">Active Calibration</span>
                  <span className="text-foreground font-mono">{predictedBond}</span>
                </div>
